(function () {
  ...
  const extra = {
    de: {
        ...
        "offer.1.body": "<p><strong>Primär dienstags 11:00–12:30 Uhr</strong> – die Gruppenzeiten rotieren und werden im Wechsel auch donnerstags abends angeboten. In der Gruppe (4–12 Personen, 90 Minuten) entsteht ein geschützter Rahmen für Entlastung und neue Perspektiven.</p><p>Viele Menschen kennen bereits kunsttherapeutisches Gestalten in Gruppen, haben die Kunsttherapie schätzen gelernt, wissen um die Wirksamkeit – und suchen einen freien Platz. Selbstverständlich auch für alle, die durch ressourcenorientierte, visuelle Methoden ganz individuelle Themen gestalten möchten – ich begleite Sie darin.</p><p><strong>Gruppentherapie, freies und thematisches Gestalten:</strong> „Kunst als Weg zurück zu deinem Inneren“ – um Gesundheit zu erhalten und zu fördern, im Sinne unserer Resilienz, der psychischen Widerstandsfähigkeit.</p><p>„Bilder sagen mehr als tausend Worte“, sowie „die Heilkraft der Farben“ sind Erfahrungswerte in der Kunsttherapie.</p><p class=\"note\">4–12 Personen · 90 Minuten · im Wechsel auch donnerstags abends</p>",
        ...
        "kt.methods.title": "Methoden in Bildern",
        "kt.methods.sub": "Einblicke aus der kunsttherapeutischen Arbeit – Klick auf ein Bild zum Vergrößern.",
        "kt.methods.1.title": "Unsere aktuelle Situation",
        "kt.methods.1.text": "Raum für nicht gelebte Trauer – Hilfe bei chronischen Schmerzen.",
        "kt.methods.1.alt": "Pastellkreide-Bild: Menschen in leuchtenden Farben unter einem Lichtbogen – Raum für Trauer und Schmerz",
        "kt.methods.2.title": "Vision Board",
        "kt.methods.2.text": "Förderung unserer Vorstellungskraft – Klarheit und Struktur finden.",
        "kt.methods.2.alt": "Vision Board: Collage aus Bildern, Worten und Fotografien – Träume verwirklichen",
        "kt.methods.3.title": "Achtsamkeit malend",
        "kt.methods.3.text": "Achtsam die Umwelt wahrnehmen – Meditationstechniken für innere Ruhe und einen neuen, wertvollen Blick auf das, was uns umgibt.",
        "kt.methods.3.alt": "Gänseblümchen auf Holz im warmen Licht – Achtsamkeit und innere Ruhe",
        "kt.methods.4.title": "Positiver Flow",
        "kt.methods.4.text": "Positiven Flow und kreative Techniken erleben – Freude am Gestalten.",
        "kt.methods.4.alt": "Gouache-Malerei mit roten Pferden in Bewegung – positiver Flow beim Gestalten",
    ...
    en: {
        ...
        "offer.1.body": "<p><strong>Primarily Tuesday 11:00–12:30</strong> – group times rotate and are also offered on Thursday evenings on alternate weeks. In the group (4–12 people, 90 minutes) a protected space opens up for relief and new perspectives.</p><p>Many people already know art therapy in groups, value its effectiveness – and are looking for an open place. Also for anyone who wants to work on individual themes through resource-oriented visual methods – I will guide you.</p><p><strong>Group therapy, free and themed creating:</strong> “art as a way back to your inner self” – to maintain and support health, in the sense of our resilience, our psychological strength.</p><p>“A picture is worth a thousand words” and “the healing power of colour” are lived experiences in art therapy.</p><p class=\"note\">4–12 people · 90 minutes · on alternate weeks also Thursday evenings</p>",
        ...
        "kt.faq4.a": "<ul><li>Space for grief that has not yet found expression</li><li>Support with chronic pain</li><li>Vision board: imagination, clarity, and structure</li><li>Mindful painting – perceiving the environment consciously; meditation techniques for inner calm</li><li>Positive flow and creative techniques</li></ul><p class=\"note\"><a href=\"#methoden\">See methods in pictures ↓</a></p>",
        ...
        "kt.methods.title": "Methods in pictures",
        "kt.methods.sub": "Glimpses of art-therapy work – click an image to enlarge.",
        "kt.methods.1.title": "Our current situation",
        "kt.methods.1.text": "Space for grief that has not yet been lived – support with chronic pain.",
        "kt.methods.1.alt": "Pastel drawing: people in glowing colours beneath an arc of light – space for grief and pain",
        "kt.methods.2.title": "Vision board",
        "kt.methods.2.text": "Strengthening our imagination – finding clarity and structure.",
        "kt.methods.2.alt": "Vision board: collage of images, words and photographs – making dreams come true",
        "kt.methods.3.title": "Mindful painting",
        "kt.methods.3.text": "Perceiving our surroundings mindfully – meditation techniques for inner calm and a new, precious view of what surrounds us.",
        "kt.methods.3.alt": "Daisy on wood in warm light – mindfulness and inner calm",
        "kt.methods.4.title": "Positive flow",
        "kt.methods.4.text": "Experiencing positive flow and creative techniques – joy in creating.",
        "kt.methods.4.alt": "Gouache painting of red horses in motion – positive flow while creating",
