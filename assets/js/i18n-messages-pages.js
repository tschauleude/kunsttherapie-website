(function () {
  ...
  const extra = {
    de: {
        ...
        "kt.methods.kicker": "Aus Martinas Atelier",
        "kt.methods.title": "Methoden, die ins Bild kommen",
        "kt.methods.sub": "Einblicke aus kunsttherapeutischem Gestalten: Farbe, Collage, Vision Board und gemeinsamer Prozess.",
        "kt.methods.card1.title": "Bilder als Sprache",
        "kt.methods.card1.text": "Wenn Worte nicht reichen, werden Farben, Formen und Linien zu einem geschützten Ausdruck.",
        "kt.methods.card2.title": "Vision Board & Collage",
        "kt.methods.card2.text": "Vorstellungskraft, Klarheit und Struktur finden – ressourcenorientiert und ohne Leistungsdruck.",
        "kt.methods.card3.title": "Freies und thematisches Gestalten",
        "kt.methods.card3.text": "Pastellkreide, Gouache, Aquarell, Acryl, Zeichnen oder Ton – das Material wird zum Erfahrungsraum.",
        "kt.methods.img1.alt": "Kunsttherapeutisches Gruppenbild mit Licht und Farben",
        "kt.methods.img2.alt": "Vision Board mit Collage-Elementen und persönlichen Zielen",
        "kt.methods.img3.alt": "Malprozess mit Vorlage, Farben und eigenem Bild",
    ...
    en: {
        ...
        "kt.methods.kicker": "From Martina's atelier",
        "kt.methods.title": "Methods that become visible",
        "kt.methods.sub": "A glimpse into art-therapeutic creating: colour, collage, vision boards, and shared process.",
        "kt.methods.card1.title": "Images as language",
        "kt.methods.card1.text": "When words fall short, colours, shapes, and lines become safe forms of expression.",
        "kt.methods.card2.title": "Vision board & collage",
        "kt.methods.card2.text": "Finding imagination, clarity, and structure – resource-oriented and without pressure.",
        "kt.methods.card3.title": "Free and themed creating",
        "kt.methods.card3.text": "Pastel chalk, gouache, watercolour, acrylic, drawing, or clay – the material becomes a space for experience.",
        "kt.methods.img1.alt": "Art therapy group image with light and colour",
        "kt.methods.img2.alt": "Vision board with collage elements and personal goals",
        "kt.methods.img3.alt": "Painting process with reference image, colours, and own artwork",
