(function () {
  ...
  "eventsPage.register.cta": "Jetzt anmelden",
  "eventsPage.register.title": "Anmeldung",
  "eventsPage.register.message": "Nachricht / Fragen (optional)",
  "eventsPage.register.messagePlaceholder": "Gibt es etwas, das ich wissen sollte?",
  "eventsPage.register.submit": "Verbindlich anmelden",
  "eventsPage.register.sending": "Wird gesendet …",
  "eventsPage.register.success": "Anmeldung eingegangen! Du erhältst eine Bestätigungs-E-Mail.",
  "eventsPage.register.error": "Leider ist ein Fehler aufgetreten – bitte erneut versuchen oder per Kontaktformular anmelden."
}, en: {
  ...
  "eventsPage.register.cta": "Register now",
  "eventsPage.register.title": "Registration",
  "eventsPage.register.message": "Message / questions (optional)",
  "eventsPage.register.messagePlaceholder": "Is there anything I should know?",
  "eventsPage.register.submit": "Register",
  "eventsPage.register.sending": "Sending …",
  "eventsPage.register.success": "Registration received! You will get a confirmation email.",
  "eventsPage.register.error": "An error occurred – please try again or register via the contact form."
} };
