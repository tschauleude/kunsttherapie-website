...
window.I18N_MESSAGES = {
  de: {
    ...
    'atelier.tool.eraser': 'Radierer',
    'atelier.tool.soft': 'Aquarell',
    ...
    'atelier.color': 'Farbe',
    'atelier.size': 'Stärke',
    'atelier.opacity': 'Deckkraft',
    'atelier.fill': 'Fläche füllen',
    'atelier.download': 'Als PNG',
    'atelier.autosaved': 'Automatisch gespeichert',
    'atelier.collageSelect': 'Kollage-Bild auswählen',
    'atelier.confirmClear': 'Alles löschen – Zeichnung und Kollage?',
    'atelier.status.undo': 'Rückgängig',
    'atelier.status.redo': 'Wiederhergestellt',
    'atelier.status.saved': 'Entwurf auf diesem Gerät gespeichert.',
    'atelier.status.loaded': 'Entwurf geladen.',
    'atelier.status.restored': 'Dein letzter Entwurf wurde wiederhergestellt.',
    'atelier.status.noDraft': 'Kein gespeicherter Entwurf gefunden.',
    'atelier.status.loadError': 'Entwurf konnte nicht geladen werden.',
    'atelier.status.saveError': 'Speichern fehlgeschlagen – weniger Bilder verwenden.',
    'atelier.status.cleared': 'Leinwand geleert.',
    'atelier.status.collageMax': 'Maximal 6 Bilder in der Kollage.',
    'atelier.status.collageAdded': 'Bild zur Kollage – ziehen zum Verschieben.',
    'atelier.status.imageError': 'Bild konnte nicht geladen werden.',
    'atelier.status.empty': 'Bitte erst etwas gestalten.',
    'atelier.status.downloaded': 'Bild heruntergeladen.',
    'atelier.status.emptySend': 'Bitte erst etwas gestalten, bevor gesendet wird.',
    'atelier.status.identity': 'Bitte Name oder E-Mail – oder „Anonym senden“.',
    'atelier.status.sending': 'Wird gesendet …',
    'atelier.status.sent': 'Vielen Dank – das Werk wurde übermittelt.',
  ...
  en: {
    ...
    'atelier.tool.eraser': 'Eraser',
    'atelier.tool.soft': 'Watercolour',
    ...
    'atelier.color': 'Color',
    'atelier.size': 'Size',
    'atelier.opacity': 'Opacity',
    'atelier.fill': 'Fill shape',
    'atelier.download': 'Download PNG',
    'atelier.autosaved': 'Auto-saved',
    'atelier.collageSelect': 'Select collage image',
    'atelier.confirmClear': 'Clear everything – drawing and collage?',
    'atelier.status.undo': 'Undone',
    'atelier.status.redo': 'Restored',
    'atelier.status.saved': 'Draft saved on this device.',
    'atelier.status.loaded': 'Draft loaded.',
    'atelier.status.restored': 'Your last draft was restored.',
    'atelier.status.noDraft': 'No saved draft found.',
    'atelier.status.loadError': 'Could not load draft.',
    'atelier.status.saveError': 'Save failed – try fewer images.',
    'atelier.status.cleared': 'Canvas cleared.',
    'atelier.status.collageMax': 'Maximum 6 collage images.',
    'atelier.status.collageAdded': 'Image added – drag to move.',
    'atelier.status.imageError': 'Could not load image.',
    'atelier.status.empty': 'Please create something first.',
    'atelier.status.downloaded': 'Image downloaded.',
    'atelier.status.emptySend': 'Please create something before sending.',
    'atelier.status.identity': 'Please enter name or email – or choose anonymous.',
    'atelier.status.sending': 'Sending …',
    'atelier.status.sent': 'Thank you – your artwork was submitted.',
    'atelier.undo': 'Undo',
    'atelier.redo': 'Redo',
    'atelier.save': 'Save',
    'atelier.load': 'Load',
...
window.I18N_PAGE_BINDINGS = {
  ...
  prices: [
    ...
    { sel: 'main .prices-material-note', key: 'prices.materialNote', attr: 'text' },
