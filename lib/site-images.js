...
const SITE_IMAGE_SLOTS = [
  ...
  {
    slot: 'home.gallery.1',
    label: 'Galerie – Bild 1 (Kunstwerk: Pferde)',
    group: 'Startseite – Galerie',
    defaultUrl: '/assets/img/kunst-pferde.jpg',
  },
  {
    slot: 'home.gallery.2',
  ...
  {
    slot: 'home.gallery.4',
    label: 'Galerie – Bild 4 (Kunstwerk: Pastell „Im Licht“)',
    group: 'Startseite – Galerie',
    defaultUrl: '/assets/img/kunst-lichtkreis.jpg',
  },
  {
    slot: 'home.gallery.5',
    label: 'Galerie – Bild 5 (Atelier-Eingang Paderborn)',
    group: 'Startseite – Galerie',
    defaultUrl: '/assets/img/atelier-eingang.jpg',
  },
  {
    slot: 'home.gallery.6',
    label: 'Galerie – Bild 6 (Kunstwerk: Vision Board)',
    group: 'Startseite – Galerie',
    defaultUrl: '/assets/img/kunst-visionboard.jpg',
  },
  {
    slot: 'about.portrait',
