...
const SITE_IMAGE_SLOTS = [
  ...
  {
    slot: 'therapy.methode.1',
    label: 'Methoden – Bild 1 (Trauer & chronische Schmerzen)',
    group: 'Kunsttherapie – Methoden',
    defaultUrl: '/assets/img/methode-trauer-schmerz.jpg',
  },
  {
    slot: 'therapy.methode.2',
    label: 'Methoden – Bild 2 (Vision Board)',
    group: 'Kunsttherapie – Methoden',
    defaultUrl: '/assets/img/methode-visionboard.jpg',
  },
  {
    slot: 'therapy.methode.3',
    label: 'Methoden – Bild 3 (Achtsamkeit & Meditation)',
    group: 'Kunsttherapie – Methoden',
    defaultUrl: '/assets/img/methode-achtsamkeit.jpg',
  },
  {
    slot: 'therapy.methode.4',
    label: 'Methoden – Bild 4 (Positiver Flow)',
    group: 'Kunsttherapie – Methoden',
    defaultUrl: '/assets/img/methode-flow.jpg',
  },
];
