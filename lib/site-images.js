...
const REC_GALERIE = {
  ...
  maxBytes: 'egal – wird beim Hochladen automatisch verkleinert',
  note: 'Die Vorschau ist klein, per Klick öffnet sich das Bild aber groß (bis 1280 px) – deshalb nicht zu klein hochladen.',
};
const REC_RAUM = {
  format: 'JPG oder WebP',
  size: '1600 × 1067 px (Querformat 3:2)',
