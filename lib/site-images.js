...
const SITE_IMAGE_SLOTS = [
  ...
  },
  {
    ...
    group: 'Startseite – Galerie',
    defaultUrl: '/assets/img/Potenziale-Kunsttherapie-Paderborn.jpg',
  },
  {
    slot: 'home.gallery.3',
    label: 'Galerie – Bild 3 (Abstrakt)',
    group: 'Startseite – Galerie',
    defaultUrl: '/assets/img/galerie-abstrakt.jpg',
  },
  {
    slot: 'home.gallery.4',
    label: 'Galerie – Bild 4 (Palliativ / Klinik)',
    group: 'Startseite – Galerie',
    defaultUrl: '/assets/img/galerie-schmerzstation.jpg',
  },
  {
    slot: 'home.gallery.5',
  ...
  {
    slot: 'home.gallery.6',
    label: 'Galerie – Bild 6 (Malen & Pinsel)',
    group: 'Startseite – Galerie',
    defaultUrl: '/assets/img/Sonnige_Pinsel.jpg',
  },
  {
    slot: 'about.portrait',
  ...
  {
    slot: 'therapy.methods.1',
    label: 'Kunsttherapie – Methoden: Trauer & Schmerz (Pastell)',
    group: 'Kunsttherapie – Methoden',
    defaultUrl: '/assets/img/methoden-trauer.jpg',
  },
  {
    slot: 'therapy.methods.2',
    label: 'Kunsttherapie – Methoden: Vision Board',
    group: 'Kunsttherapie – Methoden',
    defaultUrl: '/assets/img/methoden-visionboard.jpg',
  },
  {
    slot: 'therapy.methods.3',
    label: 'Kunsttherapie – Methoden: Achtsamkeit',
    group: 'Kunsttherapie – Methoden',
    defaultUrl: '/assets/img/methoden-achtsamkeit.jpg',
  },
  {
    slot: 'therapy.methods.4',
    label: 'Kunsttherapie – Methoden: Positiver Flow',
    group: 'Kunsttherapie – Methoden',
    defaultUrl: '/assets/img/methoden-flow.jpg',
  },
];
...
async function readOverrides(dbAll) {
  const rows = await dbAll(`SELECT slot, url, updatedAt FROM site_images`);
