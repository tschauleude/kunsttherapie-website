...
const MESSAGES = {
  de: {
    ...
    'booking.verifyEmail':
      'Fast geschafft! Bitte bestätigen Sie Ihre E-Mail-Adresse – wir haben Ihnen einen Link geschickt. Erst danach geht die Anfrage ein.',
  ...
  en: {
    ...
    'booking.verifyEmail':
      'Almost done! Please confirm your email address – we sent you a link. Your request will only be submitted after confirmation.',
    'booking.successEmail':
