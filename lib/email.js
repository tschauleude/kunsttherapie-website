...
async function sendContactMessage({ name, email: fromEmail, phone, message }) {
  ...
  await transport.sendMail({
    ...
    text: `Hallo ${name},\n\nvielen Dank für die Nachricht. Eine Rückmeldung folgt zeitnah.\n\nHerzliche Grüße\nKunsttherapie Paderborn`,
    html: `<p>Hallo ${name},</p><p>vielen Dank für die Nachricht. Eine Rückmeldung folgt zeitnah.</p><p>Herzliche Grüße<br>Kunsttherapie Paderborn</p>`,
  });
