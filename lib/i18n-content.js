...
const CATALOG = [
  ...
  },
  {
    ...
    description: 'Hero, fünf Angebote, FAQs, Atelier, Abschluss-CTA',
    fields: [
      ...
      { key: 'kt.faq1.q', label: 'FAQ 1 – Frage' },
      { key: 'kt.faq1.a', label: 'FAQ 1 – Antwort', html: true },
      { key: 'kt.faq2.q', label: 'FAQ 2 – Frage' },
      { key: 'kt.faq2.a', label: 'FAQ 2 – Antwort', html: true },
      { key: 'kt.faq3.q', label: 'FAQ 3 – Frage' },
      { key: 'kt.faq3.a', label: 'FAQ 3 – Antwort', html: true },
      { key: 'kt.faq4.q', label: 'FAQ 4 – Frage' },
      { key: 'kt.faq4.a', label: 'FAQ 4 – Antwort', html: true },
      { key: 'kt.faq5.q', label: 'FAQ 5 – Frage' },
      { key: 'kt.faq5.a', label: 'FAQ 5 – Antwort', html: true },
      { key: 'kt.faq6.q', label: 'FAQ 6 – Frage' },
      { key: 'kt.faq6.a', label: 'FAQ 6 – Antwort', html: true },
      { key: 'kt.faq7.q', label: 'FAQ 7 – Frage' },
      { key: 'kt.faq7.a', label: 'FAQ 7 – Antwort', html: true },
      { key: 'kt.faq8.q', label: 'FAQ 8 – Frage' },
      { key: 'kt.faq8.a', label: 'FAQ 8 – Antwort', html: true },
      { key: 'kt.faq9.q', label: 'FAQ 9 – Frage' },
      { key: 'kt.faq9.a', label: 'FAQ 9 – Antwort', html: true },
      { key: 'kt.faq10.q', label: 'FAQ 10 – Frage' },
      { key: 'kt.faq10.a', label: 'FAQ 10 – Antwort', html: true },
      { key: 'kt.faq11.q', label: 'FAQ 11 – Frage' },
      { key: 'kt.faq11.a', label: 'FAQ 11 – Antwort', html: true },
      { key: 'kt.faq12.q', label: 'FAQ 12 – Frage' },
      { key: 'kt.faq12.a', label: 'FAQ 12 – Antwort', html: true },
